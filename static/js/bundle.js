...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".eg-footer footer{position:absolute;top:1085px;left:0;right:0;height:50px;background-color:hsla(0,0%,100%,.7);box-shadow:0 0 3px 1px rgba(0,0,0,.2)}.eg-footer footer p{margin:0;line-height:50px;color:#8c8c8c;font-size:12px;text-align:center}", ""]);
